...
Item inputItem()
{
	...
	scanf("%d-%d-%d", &item.expiryData.HSX.day, &item.expiryData.HSX.month, &item.expiryData.HSX.year);
	getchar();

	printf("9. Nhap HSD (dd-mm-yyyy): ");
	scanf("%d-%d-%d", &item.expiryData.HSD.day, &item.expiryData.HSD.month, &item.expiryData.HSD.year);
	getchar();
...
{
	printf("======================================================================================================================================================\n");
	printf("| %-3s | %-20s | %-10s | %-10s | %-8s | %-9s | %-35s | %-18s | %-10s | %-10s | %-6s |\n",
